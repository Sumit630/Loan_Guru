...
import '../AppOpen/app_lifecycle.dart';
...
//  static const String admobSplash = "admob-splash";
  ...
  static initRemotGetData() async {
    ...
    print("fetch :: ${fetchSuccessful}");
    // Get the adStatus value from remote config
    String adStatus = _remoteConfing.getString("Loanguru");
  ...
  static saveServerDataInPreference(AdsData serverData) async {
    // await AppOpenAdManager().appOpenAds();
    print("Demarkqwmar112131`3`");
    print("serverData.adstatus :: ${serverData.adstatus}");
    ...
    print("Get Status :: ${get_Status.toString()}");
