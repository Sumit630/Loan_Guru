...
import '../controller/paydaay_controller.dart';

class PyadaySpecificPage extends StatefulWidget {
  const PyadaySpecificPage({super.key});

  @override
  State<PyadaySpecificPage> createState() => _PyadaySpecificPageState();
}

class _PyadaySpecificPageState extends State<PyadaySpecificPage> {
  @override
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10.r),
                                child: Text("${PaydaaySpecificController.payDayString}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w500,fontSize:18.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
