...
import '../controller/why_pay_day_contrlloer.dart';

class WhyPaydeyPage extends StatefulWidget {
  const WhyPaydeyPage({super.key});

  @override
  State<WhyPaydeyPage> createState() => _WhyPaydeyPageState();
}

class _WhyPaydeyPageState extends State<WhyPaydeyPage> {
  @override
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10.r),
                                child: Text("${WhyPayDayContrlloer.whyPayDayIntrodutionList}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w600,fontSize:20.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
