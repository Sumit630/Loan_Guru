...
import '../controller/variatuion_on_pay_day_controller.dart';

class VariationOnPaydayPage extends StatefulWidget {
  const VariationOnPaydayPage({super.key});

  @override
  State<VariationOnPaydayPage> createState() => _VariationOnPaydayPageState();
}

class _VariationOnPaydayPageState extends State<VariationOnPaydayPage> {
  @override
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10.r),
                                child: Text("${VariatuionOnPayDayController.variationLoansString}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w500,fontSize:18.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
