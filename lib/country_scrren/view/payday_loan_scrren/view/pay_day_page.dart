...
import '../contrlloer/pay_day_controller.dart';

class PayDayPage extends StatefulWidget {
  const PayDayPage({super.key});

  @override
  State<PayDayPage> createState() => _PayDayPageState();
}

class _PayDayPageState extends State<PayDayPage> {
  @override
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10),
                                child: Text("${PayDayController.paydayIntrodutionString}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w600,fontSize:20.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
