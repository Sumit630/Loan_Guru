...
import '../controller/comparisons_controller.dart';

class ComparisonsPage extends StatefulWidget {
  const ComparisonsPage({super.key});

  @override
  State<ComparisonsPage> createState() => _ComparisonsPageState();
}
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10.r),
                                child: Text("${ComparisonsController.comparisonsControllerString}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w500,fontSize:18.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
