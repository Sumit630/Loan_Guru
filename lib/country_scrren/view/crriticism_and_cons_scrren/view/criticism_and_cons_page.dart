                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding: EdgeInsets.all(10.r),
                                child: Text("${CriticismConsConntroller.criticismConsString}",textAlign: TextAlign.center,style: TextStyle(color: textBleckColor,fontWeight: FontWeight.w500,fontSize:18.sp,fontFamily: "Regular"),),
                              ),
                            ],
                          ),
                        ),
